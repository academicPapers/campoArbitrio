...
>- NBR 14.653-02 [@NBR1465302] parece misturar as coisas
...
```{r, fig.cap="Seleção de Variáveis baseada em critérios de ajuste."}
...
>     + Porém, alguns lotes tem melhor $Ped, Topo, PQ \,\textbf{e}\, PS$.
